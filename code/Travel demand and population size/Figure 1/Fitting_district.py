...
def plot(x_true_renkou,y_true_count,y_true_sumdistance,x_fit_renkou,y_fit_count,y_fit_sumdistance,highlight_point1,highlight_point2):
    ...
    plt.xscale('log')
    plt.yscale('log')
    #plt.title('Urban-Rural Fringe', fontsize=16,fontweight='bold')  # 设置中文标题
...
# Input
X_renkou,Y_count,X_renkou2,Y_sumdistance = shuru(data)
...
plot(data['population_district'],data['total_frequency'],data['total_distance'],
