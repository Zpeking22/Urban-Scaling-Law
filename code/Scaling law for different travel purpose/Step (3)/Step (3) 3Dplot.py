...
# Data sets can be replaced：Fitting commuting data.csv and Fitting leisure data.csv
df = pd.read_csv('Fitting commuting data.csv', encoding="GB18030")
...
plt.title('(e)Commuting distance', fontsize=20, fontweight='bold', loc='left')
